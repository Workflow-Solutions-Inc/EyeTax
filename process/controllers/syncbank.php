...
// API ->
  ...
  do {
   ...
   $apiResponse =  $apiInstance -> getBankTransactions($xeroTenantId, $if_modified_since = null, $where.' AND Status =="AUTHORISED" AND Reference != "WRITEOFF"', $order = null, $page = $curpage, $unitdp = null);
