                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                <li><a href="<?php echo $base_path; ?>Receipts.php">Excel Files</a></li>
                                ...
                                <li><a href="<?php echo $base_path; ?>syncxerodata.php">Sync xero data</a></li>
                                <li><a href="<?php echo $base_path; ?>userlogged.php">Home</a></li>
                                
                                <!-- <li><button id="showaccount" style="border:none;">Accounts</button></li> -->
                                <li class="divider"></li>
                                <li><a href="<?php echo $base_path; ?>Main.php">Disconnect To Xero</a></li>
                              </ul>
                        </li>
                        <li>
