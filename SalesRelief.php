...
<div class="wrapper">
       ...
       <div class="main-panel">
        ...
        <div class="content">
            <form action="Reports/NewSalesRelief.php" method="get">
            <div class="container-fluid">
                <div class="row">
                      <div class="col-md-12">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Sales Relief Parameters</h4>
                                ...
                                <div class="content">
                                 ...
                                 <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <button type="submit" class="btn  btn-fill pull-right">Generate Sales Relief</button>
                                            </div>
                                        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                      <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Paid Invoices (Receivables)</h4>
                            ...
                            <div class="content table-responsive table-full-width">
                               <table id="datatable" class="table table-hover table-striped">
                                    ...
                                    $query = "SELECT @rownum := @rownum + 1 AS num,iv.Invoiceid ,ci.customerName,format(sum(it.taxamount),2) as 'taxamount' , format(sum(iv.invoiceamount),2) as 'invoiceamount'  
                                                ...
                                                where iv.invoicetype = 'ACCREC' and iv.invoicestatus = 'PAID'
                                    ...
                                    { 
                                        ?>
                                            ...
                                            <td style="width:22%;"  id="inv" name="inv"><?php echo $row['Invoiceid'];?></td>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    $query = "SELECT @rownum := @rownum + 1 AS num,Invoiceid ,ci.customerName,
                                                    case when invoicestatus = 'AUTHORISED' 
                                                     ...
                                                     format(sum(iv.invoiceamount),2) as 'invoiceamount'  
                                                    FROM invoices iv
                                                    ...
                                                    where iv.invoicetype = 'ACCREC' and invoicestatus != 'PAID' 
    ...
    <script src="assets/js/demo.js"></script>
     <script type="text/javascript">
        $(document).ready(function(){
            ...
            $.notify({
                icon: 'pe-7s-cash',
                message: "Sales Relief Report Selected."
